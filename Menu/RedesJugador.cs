...
public class RedesJugador : MonoBehaviour
{
  ...
  public void showUserName() {
    GameObject name = Instantiate(text);
    name.transform.position = new Vector3(this.gameObject.transform.position.x - 0.2575f, this.gameObject.transform.position.y + 2, this.gameObject.transform.position.z);
